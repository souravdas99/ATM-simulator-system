...
public class Signup extends JFrame implements ActionListener {
	...
	Signup(){
        ...
        c1.setBounds(300,240,100,30);
        add(c1);
        
        c2.setBounds(450,240,100,30);
        add(c2);
        
        c3.setBounds(600,240,100,30);
        add(c3);
	...
	public void actionPerformed(ActionEvent ae) {
        ...
        try{
            ...
            if(t6.getText().equals("")){
                ...
                Conn conn = new Conn();
                String q1 = "insert into signup values('"+formno+"','"+name+"','"+fname+"','"+date+"','"+month+"','"+year+"','"+gender+"','"+email+"','"+marital+"','"+address+"','"+city+"','"+pincode+"','"+state+"')";
