...
public class Signup2 extends JFrame implements ActionListener{
    ...
    String speed[] = {"5","5.2","6","6.7","7","7.5","8","8.6","9","10","10.9"};
...
//    t3.setFont(new Font("Raleway", Font.BOLD, 14));
    ...
    ButtonGroup groupgender2 = new ButtonGroup();
    groupgender2.add(r3);
    groupgender2.add(r4);
...
//    add(t3);
    ...
    c1.setBounds(340,120,320,30);
    add(c1);
    
    l3.setBounds(100,170,100,30);
    add(l3);
    
    c2.setBounds(340,170,320,30);
    add(c2);
    
    l4.setBounds(100,220,100,30);
    add(l4);
    
    c3.setBounds(340,220,320,30);
    add(c3);
    
    l5.setBounds(100,270,150,30);
    add(l5);
    
    c4.setBounds(340,270,320,30);
    add(c4);
    ...
    c5.setBounds(340,340,320,30);
    add(c5);
    
    l7.setBounds(100,390,150,30);
    add(l7);
    
    t1.setBounds(340,390,320,30);
    add(t1);
    
    l8.setBounds(100,440,180,30);
    add(l8);
    
    t2.setBounds(340,440,320,30);
    add(t2);
    
    l9.setBounds(100,490,150,30);
    add(l9);
    
    r1.setBounds(340,490,100,30);
    add(r1);
    ...
    r3.setBounds(340,540,100,30);
    add(r3);
    
    r4.setBounds(450,540,100,30);
    add(r4);
    
    b.setBounds(560,640,100,30);
    add(b);
